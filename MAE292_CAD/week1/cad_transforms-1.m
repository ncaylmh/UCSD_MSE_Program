...
array = squashed;
for ii = 1:Nx
    sx = 1+sc*sin(ii/(Nx*lambda)*2*pi);
    sy = 1+sc*sin(ii/(Nx*lambda)*2*pi);
    theta = ii*(pi/4)/Nx;
    
    new_circle = T(ii*h_scale, 0)*S(sx, sy)*R(theta)*squashed;
...
axis equal;
               ...
               for ii = 1:Nx
                   ...
                   new_circle = T(ii*h_scale, 0)*S(sx, sy)*circle;
...
%大小
                              ...
                              for ii = 1:Nx
                                  ...
                                  sxtotal = 0;
                                  for iii = 1:ii
                                      sxtotal = sxtotal + s(ii);
                                  end
                                  
                                  new_circle = T((sxtotal/2+ii*h_scale), 0)*S(s(ii), s(ii))*circle;
...
%大小阵列
                                             ...
                                             for ii = 1:Nx
                                                 ...
                                                 for iiy = 1: Ny
                                                     new_circle1 = T(0, iiy*(v_scale+s(ii)))*new_circle;
